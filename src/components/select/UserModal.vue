...
<template>
  <div id="UserModal">
    <a-modal centered title="选择人员" :width="1000" :visible="visible" @cancel="closeModal">
...
export default {
  ...
  methods: {
    getTreeData() {
      this.loading = true;
      this.$get(this.api.getTreeDataApi, { orgId: this.currentOrg })
        .then(response => {
          this.loading = false;
