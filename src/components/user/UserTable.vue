...
<template>
  <div class="pannel">
        ...
        <div class="flex justify-between">
          <div class="table-config">
            <a-button
              ...
              :disabled="!isCheck"
            >新增人员</a-button>
            <a-button class="m-r-10" type="primary" v-waves @click="importUserHanle" disabled>导入人员</a-button>
            <a-button
              class="m-r-10"
              type="primary"
              v-waves
    ...
    <add-user-modal ref="addUserModal" @change="userChange" :orgMsg="orgData"></add-user-modal>
...
export default {
  ...
  components: {
    Pagination,
    collapse,
    "add-user-modal": AddUserModal, //新增、编辑 人员
    "user-info-modal": UserInfoModal, //  用户信息查看
